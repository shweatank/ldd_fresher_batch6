...
#define PROC_NAME "proc_calc_demo"
#define BUF_SIZE 128
...
INIT_WORK(&calc_work, calc_work_handler);//workqueue init
...
{
flush_work(&calc_work); //ensure work completes
