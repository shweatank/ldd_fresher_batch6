...
#define IOCTL_SET_MODE _IOW(IOCTL_MAGIC,1,struct sort)
#define IOCTL_GET_MODE _IOR(IOCTL_MAGIC,2,struct sort)
#define IOCTL_CLEAR BUFFER _IOWR(IOCTL_MAGIC,3,struct sort)
#define IOCTL_GET_WRITE_COUNT _IOWR(IOCTL_MAGIC,4,struct sort)
...
static int __init basic_char_init(void)
{
	...
	printk(KERN_INFO "create device mode with\n");
