...
#define TIMER_INTERVAL_NS 1000000 //1 ms (1,00,000 ns)
...
static int __init hrtimer_driver_init(void)
{
	...
	interval=ktime_set(0,TIMER_INTERVAL_NS); //0sec+ns
...
MODULE_DESCRIPTION("linux kernel high-resolution timer exmaple");
