...
static void oled_cmd(u8 cmd)
{
        ...
        if (i2c_master_send(client, buf, 2) != 2)
                pr_err("ssd1306: command write failed\n");
}
...
static void oled_data(u8 data)
{
        ...
        if (i2c_master_send(client, buf, 2) != 2)
                pr_err("ssd1306: data write failed\n");
}
...
/* ---------------- FONT ---------------- */
/* Paste your complete font5x7 array here */
/* static const unsigned char font5x7[95][5] = { ... }; */
static const unsigned char font5x7[95][5] = {
        /* paste your font array here */
...
static int oled_probe(struct i2c_client *i2c)
{

        pr_info("OLED probe called\n");
        ...
        if (IS_ERR(device_create(oled_class,
                                 NULL,
                                 MKDEV(major, 0),
                                 NULL,
                                 DEVICE_NAME))) {
...
static void oled_remove(struct i2c_client *i2c)
{
...
MODULE_DESCRIPTION("SSD1306 128x32 OLED I2C Driver");
