...
static irqreturn_t irq_top(int irq,void *delay)
{
...
//Request IRQ 1 (keyboard
	request_threaded_irq(IRQ_NUM,irq_top,irq_thread,IRQF_SHARED,"irq_threaded",(void*)irq_thread);
	major=register_chrdev(0,DEVICE_NAME,&fops);
	if(major<0)
	{
		pr_err("Failed to create driver\n");
		return -EFAULT;
	}
