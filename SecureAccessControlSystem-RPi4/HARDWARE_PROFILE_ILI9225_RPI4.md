...
## 9) If you send exact module label/photo later

I will produce a strict revision-specific profile:
- exact pin-to-pin table for your board silk labels
- corrected voltage notes for your module
- exact overlay changes (if any)
- zero-trial bring-up checklist
