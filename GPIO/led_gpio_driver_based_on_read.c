...
static ssize_t led_read(struct file *filep, const char *buffer, size_t len, loff_t *offset)
{
	char msg[2]={0};
...
status struct file_operations fops = {
	.owner = THIS_MODULE,
	.open = led_open,
	.write = led_write,
	.read = led_read,
...
static int __init led_init(void)
{
	...
	gpio_direction_output(GPIO_LED, 0); //Set as output, initially LOW
